...
export function TimeFilter(props) {
    ...
    */
    ...
    let selectedFilterCount = props.favoritesOn ? (<span style={{
      background: "#05f", color: "#fff",
      borderRadius: 3,
      marginLeft: 2,
    ...
    let filters = [timeLabel, "Credits", "Favorited", "Amenities"];
