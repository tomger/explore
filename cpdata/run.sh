...
DATASET=datasets/missoula.js && ./get.js --request '{"search_request":{"filters":{"date":"2019-08-06","lat":46.8620601016578,"lon":-114.01269502470818,"result_type":"VENUE","tag":[],"map_bounds":"-114.0630629530007,46.81788484027285,-113.96232709642159,46.906199044654414"}}}' | ./proto_venues.js > $DATASET && cp $DATASET ../Explore.framerfx/code/dataset.js
DATASET=datasets/chelsea.js && ./get.js --request '{"search_request":{"filters":{"date":"2019-08-06","lat":40.7428931709069,"lon":-73.99782028680697,"result_type":"VENUE","tag":[],"map_bounds":"-74.0065544903419,40.732833910818215,-73.98908608327427,40.75295090982033"}}}' | ./proto_venues.js > $DATASET && cp $DATASET ../Explore.framerfx/code/dataset.js

DATASET=datasets/denver.js && ./get.js --request '{"search_request":{"filters":{"date":"2019-08-15","lat":39.7261749993123,"lon":-104.9495865792314,"result_type":"VENUE","tag":[],"map_bounds":"-105.06231962693226,39.59940915965197,-104.83685353151841,39.85270820204076"}}}' | ./proto_venues.js > $DATASET && cp $DATASET ../Explore.framerfx/code/dataset.js
...
DATASET=datasets/houston_schedules.js && ./get.js --request '{"search_request":{"filters":{"date":"2019-08-09","lat":29.73373033928371,"lon":-95.44385406563356,"result_type":"VENUE","tag":[],"map_bounds":"-95.57811885787346,29.59252769580948,-95.30958927337771,29.87473450237387"}}}' | ./proto_schedules.js > $DATASET && cp $DATASET ../Explore.framerfx/code/dataset_schedules.js

DATASET=datasets/denver.js && ./get.js --request '{"search_request":{"filters":{"vertical":"fitness","date":"2019-08-21","lat":39.72236179251193,"lon":-105.02092487752095,"result_type":"VENUE","tag":[],"map_bounds":"-105.3993845494417,39.44727601278848,-104.59074368304539,40.03371431309924"}}}' | ./proto_venues.js > $DATASET && cp $DATASET ../Explore.framerfx/code/dataset.js
